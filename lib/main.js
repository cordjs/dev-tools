...
var Future, Optimizer, ProjectBuilder, ServerProcessManager, _, cliParser, handleChdir, normalizeBuildOptions, normalizeServerOptions, normalizePathSeparator, purgeSources, rmrf;
...
exports.main = function() {
  ...
  commands = {
    ...
    purgeOptimizedSources: function(options) {
      handleChdir(options);
      return purgeSources((preparePath(process.cwd())) + "/" + options.out);
    },
