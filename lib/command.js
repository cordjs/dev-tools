...
commander.option('-a, --autorestart', 'autorestart server').option('-b, --build', 'build project').option('-c, --clean', 'clean target').option('-d, --dev', 'development mode - copy all files to the outputDir').option('-o, --output [dir]', 'output directory [' + outputDir + ']', outputDir).option('-f, --config [name]', 'configuration file name [' + config + ']', config).option('-p, --port [port]', 'server listening port [' + port + ']', port).option('-s, --server', 'start server').option('-w, --watch', 'watch scripts for changes and rerun commands').version(packageInfo.version, '-v, --version');
