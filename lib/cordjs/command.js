...
var CoffeeScript, Cordjs, EmptyArguments, aFiles, addWidgetWaitCompiler, baseDirFull, basePath, commander, compileWidget, copyFile, create, createDir, exec, exists, existsSync, fs, getWidgetPath, hidden, iErrServerStart, isDiffSource, isServerRestart, mainCommand, otherCommand, outputDir, outputPath, path, pathToCore, pathToNodeInit, printLine, printWarn, publicDir, removeDirSync, removeSource, requirejs, restartServer, serverChild, sources, spawn, startServer, stopServer, syncFile, syncFiles, testCommandDir, timeEnd, timeStart, timerErrServer, unwatchDir, util, wait, walk, watchDir, watchFile, watchModeEnable, widgetsWaitComliler, _endTimer, _ref, _startTimer;
