...
exports.run = function() {
  var command, type;
  type = process.argv.slice(2).shift().split(':');
  command = type[1];
  if (command != null) {
...
version = function() {
  return printLine("Cordjs version " + Cordjs.VERSION);
};
