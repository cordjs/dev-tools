...
OptionsList = [['-a', '--autorestart', 'autorestart server'], ['-b', '--build', 'build project'], ['-d', '--dev', 'development mode - copy all files to the outputDir'], ['-h', '--help', 'display this help message'], ['-o', '--output [DIR]', 'output directory'], ['-s', '--server', 'start server'], ['-w', '--watch', 'watch scripts for changes and rerun commands']];
...
restartServer = function() {
  stopServer();
  startServer();
  return timeLog('Server restarted');
};
