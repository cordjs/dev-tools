    ...
    */
    ...
    function Future(initialCounter, name) {
      ...
      */
      ...
      this._name = name;
      if (this._name) {
        if ((_ref = global.config) != null ? _ref.debug.core : void 0) {
          setTimeout(function() {
            if (_this.state() === 'pending' && _this._counter > 0) {
              return _console.warn('Future uncompleted', _this._name);
            }
          }, 10 * 1000);
        }
      }
    ...
    Future.prototype.clearDoneCallbacks = function() {
      return this._doneCallbacks = [];
    };

    Future.prototype.clearFailCallbacks = function() {
      return this._failCallbacks = [];
    };

    Future.prototype.clearAllCallbacks = function() {
      this._doneCallbacks = [];
      return this._failCallbacks = [];
    };
