    ...
    function Future(initialCounter, name) {
      ...
      if (this._name) {
        if ((_ref = global.config) != null ? _ref.debug.core : void 0) {
          this._incompleteTimeout = setTimeout((function(_this) {
            return function() {
              if (_this.state() === 'pending' && _this._counter > 0) {
                return _console.warn("Future timeouted [" + _this._name + "] (10 seconds), counter = " + _this._counter);
              }
            };
          })(this), 10 * 1000);
        }
