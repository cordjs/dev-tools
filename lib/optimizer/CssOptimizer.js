...
CssOptimizer = (function() {
  ...
  */
  ...
  CssOptimizer.prototype.run = function() {
    ...
    return Future.call(fs.readFile, cssStatFile).flatMap(function(data) {
      var groupMap, stat;
  ...
  CssOptimizer.prototype._generateOptimizedFiles = function(groupMap) {
    ...
    */
    ...
    return this._mergeGroups(groupMap).flatMap(function(mergedGroupMap) {
  ...
  CssOptimizer.prototype._mergeGroup = function(cssFiles) {
    ...
    */
    ...
    return Future.sequence(futures).zip(this.zDirFuture).flatMap(function() {
