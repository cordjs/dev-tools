...
CssOptimizer = (function() {
  ...
  * and so on
  ...
  CssOptimizer.prototype._mergeGroups = function(groupMap) {
     ...
     */
    var cssFiles, fn, groupId, result, resultMap;
    result = new Future(1);
    resultMap = {};
    fn = (function(_this) {
  ...
  CssOptimizer.prototype._mergeGroup = function(cssFiles) {
    ...
    savePromise = Future.sequence(futures).zip(this.zDirFuture).flatMap((function(_this) {
      return function() {
    ...
    return Future.sequence([savePromise, Future.sequence(removePromises)]).spread(function(savePromiseResult) {
