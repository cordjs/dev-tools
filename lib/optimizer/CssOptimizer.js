...
var CleanCss, CorrelationGroupDetector, CssOptimizer, Future, GroupRepo, HeuristicGroupDetector, cleanCss, fs, mkdirp, path, relativeReplaceRe, sha1, _;
  ...
  */
  ...
  CssOptimizer.prototype._generateOptimizedFiles = function(groupMap) {
    ...
    */
    ...
    return this._mergeGroups(groupMap);
  };
  ...
  CssOptimizer.prototype._mergeGroups = function(groupMap) {
    ...
    */
    ...
    result = new Future(1);
    resultMap = {};
    this._cleanFuture = Future.resolved().flatMap(function() {
      return Future.call(mkdirp, _this._zDir);
    });
    _fn = function(cssFiles) {
      result.fork();
      return _this._mergeGroup(_this._reorderGroupFiles(cssFiles)).done(function(fileName) {
  ...
  CssOptimizer.prototype._mergeGroup = function(cssFiles) {
    ...
    */
    ...
    return Future.sequence(futures).zip(this._cleanFuture).flatMap(function() {
  ...
  CssOptimizer.prototype._reorderGroupFiles = function(cssFiles) {
    ...
    */
    ...
    var _this = this;
    return _.sortBy(cssFiles, function(f) {
