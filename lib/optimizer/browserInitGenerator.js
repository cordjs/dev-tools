...
exports.generate = function(params, jsGroupMap, cssGroupMap) {
  ...
  var e;
  try {
    return Future.all([requirejsConfig.collect(params.targetDir), Future.call(fs.readFile, path.join(params.targetDir, templateFile), 'utf8')]).spread(function(requireConf, tmplString) {
