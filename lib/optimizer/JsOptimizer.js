...
JsOptimizer = (function() {
  ...
  */
  ...
  JsOptimizer.prototype.run = function() {
    ...
    return Future.call(fs.readFile, statFile).mapFail(function() {
      ...
      return _this._generateOptimizationMap(stat);
    }).flatMap(function(groupMap) {
  ...
  JsOptimizer.prototype._generateOptimizationMap = function(stat) {
    /*
