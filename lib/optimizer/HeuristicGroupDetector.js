...
HeuristicGroupDetector = (function() {
  ...
  HeuristicGroupDetector.prototype.process = function(stat) {
    var group, lengthBefore, module, moduleList, moduleMap, modules, optimizedStat, page, pages, remaining, resultGroups, _i, _j, _k, _len, _len1, _len2, _ref, _ref1,
      _this = this;
    this._countMap = {};
    ...
    remaining = (_.sortBy(remaining, function(m) {
    ...
    for (page in stat) {
      ...
      for (_k = 0, _len2 = resultGroups.length; _k < _len2; _k++) {
        group = resultGroups[_k];
    ...
    if ((new Date).getTime() < this._thresholdTime) {
      for (i = _i = startIndex, _ref = list.length; startIndex <= _ref ? _i <= _ref : _i >= _ref; i = startIndex <= _ref ? ++_i : --_i) {
        ...
        if (cnt > 0) {
          ...
          scoreArr = _.map(group, function(m) {
          ...
          if (score > this._maxGroupScore && group.length > 1) {
            ...
            this._thresholdTime = (new Date).getTime() + 30000;
