...
(function() {
  var CorrelationGroupDetector, _, sha1;
  ...
  CorrelationGroupDetector = (function() {
    ...
    CorrelationGroupDetector.prototype.process = function(stat) {
      var checksum, checksums, filteredGroups, groupId, groupModules, module, moduleList, modules, optimizedStat, page, pages, ref;
      checksums = {};
    ...
    CorrelationGroupDetector.prototype._mapStat = function(stat) {
      var i, len, module, moduleList, page, result;
      result = {};
      for (page in stat) {
        moduleList = stat[page];
