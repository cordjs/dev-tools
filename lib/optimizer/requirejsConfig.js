...
var Future, appConfFile, path, pathConfigFile, requirejs, savedConfigFuture, _,
  __slice = [].slice;
...
exports.collect = function(targetDir) {
  ...
  */
  ...
  if (savedConfigFuture) {
    ...
    return savedConfigFuture = Future.require(appConfFile).flatMap(function(bundles) {
      var bundle, configs;
      bundles.unshift('cord/core');
      configs = (function() {
