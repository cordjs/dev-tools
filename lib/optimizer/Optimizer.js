...
var ByWidgetGroupDetector, CorrelationGroupDetector, CssOptimizer, Future, GroupRepo, HeuristicGroupDetector, Optimizer, UglifyJS, browserInitGenerator, coffeeUtilCode, fs, mkdirp, requirejsConfig, rmrf, sha1, _;
...
Optimizer = (function() {
  ...
  */
  ...
  Optimizer.prototype.run = function() {
    var cssOptimizer, start, statFile,
      _this = this;
    ...
    fs.readFile(statFile, function(err, data) {
      ...
      return _this._generateOptimizationMap(stat).flatMap(function(groupMap) {
    ...
    cssOptimizer = new CssOptimizer(this.params);
    return cssOptimizer.run();
  };
  ...
  Optimizer.prototype._generateOptimizationMap = function(stat) {
    ...
    */
    ...
    return widgetDetector.process(stat).map(function(stat) {
      var corrDetector, group, groupId, groups, heuristicDetector, page, resultMap, _i, _len;
      while (iterations--) {
  ...
  Optimizer.prototype._mergeGroups = function(groupMap, requireConf) {
    ...
    */
    ...
    result = new Future(1);
    resultMap = {};
    this._cleanFuture = (this.params.clean ? rmrf(this._zDir) : Future.resolved()).flatMap(function() {
