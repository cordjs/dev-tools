...
Optimizer = (function() {
  ...
  */
  ...
  Optimizer.prototype.run = function() {
    var cssOptimizer, jsOptimizer, start, zDirFuture,
      _this = this;
    ...
    cssOptimizer = new CssOptimizer(this.params, zDirFuture);
    return jsOptimizer.run().zip(cssOptimizer.run()).flatMap(function(jsGroupMap, cssGroupMap) {
