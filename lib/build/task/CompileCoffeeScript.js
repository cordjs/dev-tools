...
CompileCoffeeScript = (function(superClass) {
  extend(CompileCoffeeScript, superClass);
  ...
  CompileCoffeeScript.prototype.run = function() {
    var basename, compilePromise, dirname, dstBasename, dstDir, dstName, src;
    ...
    dstDir = this.params.targetDir + "/" + dirname;
    ...
    compilePromise = Future.call(fs.readFile, src, 'utf8').then((function(_this) {
      return function(coffeeString) {
        ...
        answer = coffee.compile(coffeeString, {
          ...
          sourceRoot: "./",
          sourceFiles: [path.relative(dstDir, _this.params.baseDir + "/" + dirname) + ("/" + basename + ".coffee")],
    ...
    return Future.all([compilePromise, Future.call(mkdirp, path.dirname(dstBasename))]).spread((function(_this) {
      return function(answer) {
        return Future.all([Future.call(fs.writeFile, dstBasename + ".js", answer.js), void 0 !== answer.v3SourceMap ? Future.call(fs.writeFile, dstBasename + ".map", answer.v3SourceMap) : void 0]);
      };
