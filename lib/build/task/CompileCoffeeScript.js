...
CompileCoffeeScript = (function(superClass) {
  ...
  CompileCoffeeScript.prototype.run = function() {
    var basename, dirname, dstBasename, dstDir, dstName, src;
    ...
    return Future.call(fs.readFile, src, 'utf8').map((function(_this) {
      ...
      return function(answer) {
        return Future.sequence([Future.call(fs.writeFile, dstBasename + ".js", answer.js), void 0 !== answer.v3SourceMap ? Future.call(fs.writeFile, dstBasename + ".map", answer.v3SourceMap) : Future.resolved()]);
      };
