    ...
    return Future.call(fs.readFile, src, 'utf8').map((function(_this) {
      ...
      return function(answer) {
        return Future.sequence([
          Future.call(fs.writeFile, "" + dstBasename + ".js", answer.js), void 0 !== answer.v3SourceMap ? Future.call(fs.writeFile, "" + dstBasename + ".js.map", answer.v3SourceMap) : Future.resolved(), void 0 !== answer.v3SourceMap ? Future.call(fs.symlink, src, "" + dstBasename + ".coffee")["catch"](function() {
            return void 0;
          }) : Future.resolved()
        ]);
      };
