...
var BuildTask, CopyFile, fs, mkdirp, path, _ref,
...
CopyFile = (function(_super) {
  ...
  function CopyFile() {
    _ref = CopyFile.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  CopyFile.prototype.run = function() {
    ...
    return mkdirp(path.dirname(dst), function(err) {
      var r;
      if (err) {
        throw err;
      }
  ...
  CopyFile.prototype.getWorkload = function() {
    return 0.2;
  };
