...
var BuildTask, CompileTemplateToVdom, Future, astToHyperscript, compilePropValue, compileWidget, dustVdom, fs, mergeTextChunks, mkdirp, path, propsToHyperscript, _,
  ...
  chunks = (function() {
    ...
    for (_i = 0, _len = ast.length; _i < _len; _i++) {
      ...
      switch (node.type) {
        case 'html_tag':
          if (node.name === 'widget') {
            _results.push(compileWidget(node, indent));
          } else {
            contentsStr = '';
            if (node.contents) {
            ...
            _results.push("h('" + node.name + "'" + idStr + propsStr + contentsStr + ")");
          }
          break;
        case 'text':
...
compileWidget = function(node, indent) {
  var contentsStr, i, prop, propsStr, type, _i, _len, _ref;
  if (indent == null) {
    indent = 0;
  }
  contentsStr = '';
...
propsToHyperscript = function(props, indent) {
  ...
  chunks = (function() {
    ...
    for (_i = 0, _len = props.length; _i < _len; _i++) {
      ...
      _results.push("" + propInfo.name + ": " + value);
    }
    return _results;
  })();
