...
var BuildSession, EventEmitter, Future, ProjectBuilder, ProjectWatcher, _, appConfig, buildManager, fileInfo, fs, fswalker, path, normalizePathSeparator, requirejs, requirejsConfig, rmrf, sourceModified, walkerFilter,
...
ProjectBuilder = (function(superClass) {
  ...
  function ProjectBuilder(params) {
    this.params = params;
    this.params.baseDir = normalizePathSeparator(this.params.baseDir);
        ...
        currentSessionPromise = _this._previousSessionPromise.flatMap(function() {
          ...
          return Future.sequence(rmList).flatMap(function() {
            ...
            scanDir = function(dir) {
              ...
              walker.on('directory', function(root, stat, next) {
                sessionCompletePromise.done(function() {
                  return _this.watchDir(normalizePathSeparator(root + "/" + stat.name));
                });
                return next();
              });
              walker.on('end', function() {
