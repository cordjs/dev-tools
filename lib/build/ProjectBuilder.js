...
var EventEmitter, Future, ProjectBuilder, buildManager, getFileInfo, inWidgetsDir, isCoffee, isStylus, isWidgetClass, isWidgetTemplate, path, requirejs, walk,
...
getFileInfo = function(file, bundle) {
  var bundleOk, bundleParts, ext, fileName, fileWithoutExt, i, inBundleIndex, inBundles, inModels, inPublic, inTemplates, inWidgets, isBehaviour, isWidget, lastDirName, lowerName, p, parts, _i, _len;
