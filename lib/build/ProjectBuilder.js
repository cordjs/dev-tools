...
var EventEmitter, Future, ProjectBuilder, ProjectWatcher, buildManager, fileInfo, fs, path, requirejs, rmrf, sourceModified, walk, _,
  ...
  */
  ...
  ProjectBuilder.prototype.setupWatcher = function() {
    ...
    return this.watcher.on('change', function(changes) {
      var removed, _i, _len, _ref, _results;
