...
var BuildSession, EventEmitter, Future, ProjectBuilder, ProjectWatcher, appConfig, buildManager, fileInfo, fs, fswalker, path, requirejs, requirejsConfig, rmrf, sourceModified, walkerFilter, _,
...
ProjectBuilder = (function(_super) {
  ...
  ProjectBuilder.prototype.build = function() {
    ...
    fullCompletePromise = this.params.indexPageWidget ? requirejsConfig(this.params.targetDir).then(function() {
