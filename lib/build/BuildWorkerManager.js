...
BuildWorkerManager = (function() {
   ...
   */
  BuildWorkerManager.MAX_SENDING_TASKS = 50;
  ...
  function BuildWorkerManager(manager) {
    ...
    childExecArgv = process.execArgv.filter(function(arg) {
      return -1 === arg.indexOf('--debug');
    });
  ...
  BuildWorkerManager.prototype.addTask = function(taskParams) {
    ...
    if (this.canAcceptTask()) {
      ...
      return this._tasks[taskParams.id]["finally"]((function(_this) {
        return function() {
          _this._workload -= taskWorkload;
          _this._sendingTask--;
          if (!_this._acceptReady.completed() && _this.canAcceptTask()) {
