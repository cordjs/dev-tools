...
ProjectWatcher = (function(superClass) {
  ...
  ProjectWatcher.prototype._readdir = function(dir) {
     ...
     */
    return Future.call(fs.readdir, dir).then(function(dirList) {
      var fList, name;
      fList = (function() {
        var i, len, results;
        results = [];
        for (i = 0, len = dirList.length; i < len; i++) {
          ...
          results.push((function(name) {
            return Future.call(fs.lstat, path.join(dir, name)).then(function(stat) {
              stat.name = name;
              return stat;
            });
          })(name));
      ...
      return Future.all(fList).then(function(statList) {
  ...
  ProjectWatcher.prototype._analyzeAndEmit = function(dirList) {
    ...
    @return Future
     */
    var dir, fn, resultPromise, summaryChangeMap, summaryRemoveList, watchInfo;
    ...
    fn = (function(_this) {
      return function(dir, watchInfo) {
        ...
        return Future.all([oldContents, newContents]).spread(function(oldMap, newMap) {
    ...
    return resultPromise.then((function(_this) {
      return function() {
