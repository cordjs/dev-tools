...
var FileInfo, detectTestPathRegExp, path, sep;
...
FileInfo = (function() {
  ...
  FileInfo.getFileInfo = function(file, bundle) {
     ...
     */
    var bundleOk, bundleParts, ext, fileName, fileWithoutExt, i, inBundleIndex, inBundles, inModels, inPublic, inTemplates, inWidgets, isBehaviour, isCollection, isModelRepo, isWidget, isWidgetTemplate, lastDirName, lowerName, p, parts, _i, _len;
    parts = file.split(path.sep);
    ...
    return {
      ...
      isHtml: ext === '.html',
      isStylus: ext === '.styl',
      isTestSpec: file.match(detectTestPathRegExp) != null
    };
  };
