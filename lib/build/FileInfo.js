  ...
  */
  ...
  FileInfo.getFileInfo = function(file, bundle) {
    ...
    */
    ...
    var bundleOk, bundleParts, ext, fileName, fileWithoutExt, i, inBundleIndex, inBundles, inModels, inPublic, inTemplates, inWidgets, isBehaviour, isModelRepo, isWidget, isWidgetTemplate, lastDirName, lowerName, p, parts, _i, _len;
    parts = file.split(path.sep);
