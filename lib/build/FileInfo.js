...
FileInfo = (function() {
  ...
  FileInfo.getFileInfo = function(file, bundle) {
     ...
     */
    var bundleOk, bundleParts, ext, fileName, fileWithoutExt, i, inBundleIndex, inBundles, inModels, inPublic, inTemplates, inWidgets, isBehaviour, isCollection, isModelRepo, isTestSpec, isWidget, isWidgetTemplate, lastDirName, lowerName, p, parts, regExp, sep, _i, _len;
    parts = file.split(path.sep);
    ...
    if (inPublic) {
      ...
      isTestSpec = file.match(regExp) != null;
    }
    return {
      fileName: fileName,
      ext: ext,
      ...
      isHtml: ext === '.html',
      isStylus: ext === '.styl',
      isTestSpec: isTestSpec != null ? isTestSpec : false
    };
  };
